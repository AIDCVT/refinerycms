module Refinery
  module SiteBarHelper
    ...
    def site_bar_switch_link
      link_to_if(admin?, translate('.switch_to_your_website', **site_bar_translate_locale_args),
                 refinery.root_path(site_bar_translate_locale_args),
                 'data-turbolinks' => false) do
        link_to translate('.switch_to_your_website_editor', **site_bar_translate_locale_args),
    ...
    def site_bar_edit_link
      ...
      link_to translate('refinery.admin.pages.edit', **site_bar_translate_locale_args),
              edit_page_path,
